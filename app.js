...
const questions = [
  ...
  { level: "easy", kanji: "多い", icon: "", choices: ["おおい", "すくない", "ながい"], answer: "おおい" },
  { level: "easy", kanji: "少ない", icon: "", choices: ["すくない", "おおい", "みじかい"], answer: "すくない" },
  ...
  { level: "easy", kanji: "入る", icon: "➡️", choices: ["いる", "でる", "たつ"], answer: "いる" },
  { level: "easy", kanji: "出る", icon: "⬅️", choices: ["でる", "いる", "はしる"], answer: "でる" },
  { level: "easy", kanji: "立つ", icon: "🧍", choices: ["たつ", "はしる", "とまる"], answer: "たつ" },
  { level: "easy", kanji: "走る", icon: "🏃", choices: ["はしる", "あるく", "とまる"], answer: "はしる" },
  { level: "easy", kanji: "止まる", icon: "🛑", choices: ["とまる", "はしる", "あるく"], answer: "とまる" },
  { level: "easy", kanji: "歩く", icon: "🚶", choices: ["あるく", "はしる", "とまる"], answer: "あるく" },
  { level: "easy", kanji: "見る", icon: "👀", choices: ["みる", "きく", "はなす"], answer: "みる" },
  { level: "easy", kanji: "聞く", icon: "👂", choices: ["きく", "みる", "よむ"], answer: "きく" },
  { level: "easy", kanji: "話す", icon: "💬", choices: ["はなす", "よむ", "かく"], answer: "はなす" },
  { level: "easy", kanji: "読む", icon: "📖", choices: ["よむ", "かく", "かう"], answer: "よむ" },
  { level: "easy", kanji: "書く", icon: "✍️", choices: ["かく", "よむ", "うる"], answer: "かく" },
  { level: "easy", kanji: "買う", icon: "🛒", choices: ["かう", "うる", "いく"], answer: "かう" },
  { level: "easy", kanji: "売る", icon: "💰", choices: ["うる", "かう", "くる"], answer: "うる" },
  { level: "easy", kanji: "行く", icon: "🚶", choices: ["いく", "くる", "たべる"], answer: "いく" },
  { level: "easy", kanji: "来る", icon: "👋", choices: ["くる", "いく", "のむ"], answer: "くる" },
  { level: "easy", kanji: "食べる", icon: "🍽️", choices: ["たべる", "のむ", "ねる"], answer: "たべる" },
  { level: "easy", kanji: "飲む", icon: "🥤", choices: ["のむ", "たべる", "おきる"], answer: "のむ" },
  { level: "easy", kanji: "切る", icon: "✂️", choices: ["きる", "お", "つく"], answer: "きる" },
  { level: "easy", kanji: "学ぶ", icon: "🎓", choices: ["まなぶ", "ならう", "おしえる"], answer: "まなぶ" },
  { level: "easy", kanji: "習う", icon: "📝", choices: ["ならう", "まなぶ", "おしえる"], answer: "ならう" },
  { level: "easy", kanji: "教える", icon: "👨‍🏫", choices: ["おしえる", "ならう", "まなぶ"], answer: "おしえる" },];
