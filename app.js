...
const questions = [
  ...
  { grade:"g1", kanji:"二", icon:"2️", choices:["に","いち","さん"], answer:"に" },
  { grade:"g1", kanji:"三", icon:"3️", choices:["さん","に","よん"], answer:"さん" },
  { grade:"g1", kanji:"四", icon:"4️", choices:["よん","さん","ご"], answer:"よん" },
  { grade:"g1", kanji:"五", icon:"5️", choices:["ご","よん","ろく"], answer:"ご" },
  { grade:"g1", kanji:"六", icon:"6️", choices:["ろく","ご","しち"], answer:"ろく" },
  { grade:"g1", kanji:"七", icon:"7️", choices:["しち","ろく","はち"], answer:"しち" },
  { grade:"g1", kanji:"八", icon:"8️", choices:["はち","しち","く"], answer:"はち" },
  { grade:"g1", kanji:"九", icon:"9️", choices:["きゅう","はち","じゅう"], answer:"きゅう" },
